...
def build_packages(root: Path, dist_dir: Path, clean: bool = False, dry_run: bool = False) -> dict[str, object]:
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        manifest = build_packages(root, dist_dir, clean=args.clean, dry_run=args.dry_run)
